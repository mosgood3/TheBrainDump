...
import WhatYoullBuild from '../components/marketing/WhatYoullBuild';
...
export default function Home() {
  ...
  // Redirect authenticated users to lessons page (happens in background)
  useEffect(() => {
    if (!loading && user) {
  ...
  return (
    <>
      <Head>
        <title>The Brain Dump - Build Apps Without Coding | No-Code Development Course</title>
        <meta name="description" content="Learn to build full-stack web applications without coding experience. The Brain Dump teaches non-technical people how to create apps using AI, no-code tools, and modern frameworks. Start building today!" />
        <meta name="keywords" content="the brain dump, no-code, low-code, build apps without coding, learn app development, AI-powered development, non-technical coding, beginner app building, learn to code" />
      </Head>
      <Layout>
        <Hero onStartJourney={handleStartJourney} />
        <WhatYoullBuild />
        <CharacterIntro />
        <main id="pricing" className="max-w-7xl mx-auto px-4 py-8">
          <Pricing />
        </main>
          ...
          <div className="p-8 md:p-16">
            ...
            <div className="text-center mt-12">
              ...
              <p className="text-sm text-gray-400 mt-6 flex items-center justify-center gap-2">
                ...
                Free to browse • Amazon affiliate links
              </p>
            </div>
