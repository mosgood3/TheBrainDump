  ...
  return (
    <div className="px-6 py-5 border-b border-gray-100">
      ...
      <div className="flex items-center justify-between mb-5">
        <h3 className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Free Lessons</h3>
        <div className="flex items-center gap-1.5">
          <div className="w-2 h-2 bg-green-500 rounded-full"></div>
          <span className="text-xs font-medium text-green-700">Free Access</span>
        </div>
      </div>

      {/* Lessons */}
      <nav className="space-y-3">
        {lessons.filter(lesson => lesson.id === 1 || lesson.id === 2).map((lesson) => {
