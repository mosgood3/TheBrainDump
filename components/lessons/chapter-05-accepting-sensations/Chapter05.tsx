...
interface AcceptingSensationsLessonProps {
  onComplete?: () => void;
  onSubsectionComplete?: (subsectionId: string) => void;
}

export default function AcceptingSensationsLesson({}: AcceptingSensationsLessonProps) {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <div className="flex-1 max-w-4xl mx-auto p-4 sm:p-6">
        ...
        {/* Lesson Title */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-4">Accepting the Sensations</h1>
          <p className="text-lg text-gray-600">Learning to coexist peacefully with physical anxiety symptoms</p>
        </div>
