...
// Overview Sublesson Component for What Is Anxiety
export function WhatIsAnxietyOverviewSublesson({ onComplete: _onComplete, isCompleted: _isCompleted }: { onComplete: () => void; isCompleted: boolean }) {
      ...
      <div className="aspect-video bg-gradient-to-br from-blue-500 to-orange-500 rounded-lg overflow-hidden">
        {!isPlaying ? (
          ...
          <video
            ...
            playsInline
          >
            <source src="/videos/Chapter2.mp4" type="video/mp4" />
